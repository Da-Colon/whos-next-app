...
const ContainerImage = () => {
  return (
    <div className="w-full h-full">
      ...
      <div className="static sm:absolute top-36 left-0 sm:left-auto sm:right-4 text-lg text-gold p-8 text-center max-w-128" style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}>
