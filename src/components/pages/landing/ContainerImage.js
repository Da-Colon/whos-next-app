...
const ContainerImage = () => {
  return (
    <div className="w-full h-full">
      <div className="background-main max-w-128" style={{height: '100%'}}>
        {/* !!TODO Add background image to div */}
      </div>
      <div className="static sm:absolute top-36 left-0 sm:left-auto sm:right-4 text-20 text-gold p-8 text-center max-w-128" style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}>
